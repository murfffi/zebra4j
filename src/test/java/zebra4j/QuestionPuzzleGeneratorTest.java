...
public class QuestionPuzzleGeneratorTest {
	...
	public void testGenerate_Stable() {
		PuzzleSolution startSolution = PuzzleGeneratorTest.simpleSolutionWithCriminal();
		QuestionPuzzle puzzle1 = new QuestionPuzzleGenerator(Question.NAME_OF_CRIMINAL, startSolution,
				TestUtils.NOOP_RANDOM, AbstractPuzzleGenerator.DEFAULT_FACT_TYPES).generate();
		QuestionPuzzle puzzle2 = new QuestionPuzzleGenerator(Question.NAME_OF_CRIMINAL, startSolution,
				TestUtils.NOOP_RANDOM, AbstractPuzzleGenerator.DEFAULT_FACT_TYPES).generate();
